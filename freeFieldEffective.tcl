...
set numLayers      2
# layer thicknesses
set layerThick(2)  15.0
set layerThick(1)  15.0
...
nDMaterial PressureDependMultiYield02 2 2 1.51 7.1e3 2.1e4 36.53 0.1 \
                                      101.0 0.5 25.5 0.067 0.23 0.06 \
                                      0.27 20 5.0 3.0 1.0 \
                                      0.0 1.61 0.9 0.02 0.7 101.0
set thick(2) 1.0
...
set hPerm(2) 4.21e-5
set vPerm(2) 4.21e-5
nDMaterial PressureDependMultiYield02 1 2 1.53 8.6e3 2.6e4 37.68 0.1 \
                                      101.0 0.5 26 0.010 0.0 0.35 \
                                      0.0 20 5.0 3.0 1.0 \
                                      0.0 1.541 0.9 0.02 0.7 101.0
set thick(1) 1.0
